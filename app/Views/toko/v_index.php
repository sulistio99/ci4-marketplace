    ...
    <div class="card card-dark card-outline">
        <div class="card-body box-profile">
            ...
            <div class="row text-center">
                ...
                <div class="col-sm-3">
                    <i class="fa-brands fa-square-whatsapp"></i> <a href="https://wa.me/<?= $user['no_hp']; ?>" class="text-dark"><?= $user['no_hp']; ?></a>
                </div>
                <div class="col-sm-3">
                    <i class="fas fa-user-check"></i> Bergabung: <span class="text-success"> <?= date('d M Y', strtotime($user['tanggal_lahir'])); ?></span>
                </div>
                <div class="col-3">
                    <i class="fas fa-store"></i> <a href="<?= base_url('Home/DetailToko/' . $user['id_user']); ?>" class="text-dark">Produk: <span class="text-success"><?= $totalbarang; ?></span></a>
                </div>
            </div>
        </div>
        <!-- /.card-body -->
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control form-control-lg" placeholder="Cari ditoko ini..." name="keywoard">
