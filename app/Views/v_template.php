            ...
            <div class="col">
              ...
              <header>
                <div class="container my-4">
                  <div id="carouselExampleControls" class="carousel slide " data-ride="carousel" style="border: 1px solid grey;">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="<?= base_url('foto/6.jpg'); ?>" class="d-block w-100" style="height:350px ;">
                      </div>
                      <div class="carousel-item">
                        <img src="<?= base_url('foto/1.jpg'); ?>" class="d-block w-100" style="height:350px ;">
                      </div>
                      <div class="carousel-item">
                        <img src="<?= base_url('foto/3.jpg'); ?>" class="d-block w-100" style="height:350px ;">
                      </div>
                    </div>
              ...
              <div class="row text-center mt-2">
                <div class="col">
                  <h4>KATEGORI</h4>
                  <hr size="10px" width="100%" style="margin: auto; color:darkgreen;" class="mb-2">
                  <div class="row">
                    <?php foreach ($kategori as $key => $value) { ?>
                      <div class="col-sm-2">
                        <a href="<?= base_url('Home/Kategori/' . $value['id_kategori']); ?>" class="text-reset">
                          <img src="<?= base_url('foto/Kategori/' . $value['foto']); ?>" class="img img-circle img-thumbnail" class="img img-circle" width="100px">
                          <h5><?= $value['nama_kategori']; ?></h5>
                        </a>
                      </div>
                    <?php } ?>
                  </div>
                  <hr size="10px" width="100%" style="margin: auto; color:darkgreen;">
                </div>
              </div>
              <!-- end kategori -->
            </div>
