          ...
          foreach ($barang as $key => $value) { ?>
            <tr>
              ...
              <td>
                ...
                <i class="fa-solid fa-rupiah-sign"></i> <?= number_to_currency($value['harga_barang'], 'Rp.') ?>
              </td>
              <td><?= date('d M Y', strtotime($value['tanggal'])); ?></td>
              <td><?= $value['status']; ?></td>
              <td><?= $value['deskripsi']; ?></td>
              <td class="text-center">
                <a href="<?= base_url('User/UbahBarang/' . $value['id_barang']); ?>" class="btn btn-warning btn-sm btn-flat"><i class="fa fa-edit"></i> Ubah</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <?php echo form_open_multipart(base_url('User/DeleteDataBarang/' . $value['id_barang'])) ?>
          <div class="form-group">
            <label>Yakin Mau Hapus? <?= $value['nama_barang']; ?></label>
          </div>
        </div>
