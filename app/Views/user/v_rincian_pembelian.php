        ...
        <div class="col-12 table-responsive">
          ...
          <table id="" class="table table-bordered">
            ...
            <tbody>
              ...
              <tr class="bg-secondary">
                <td colspan="2">Rekening Bersama</td>
                <td>0835307024 </td>
              </tr>
              <tr class="bg-secondary">
              ...
              <tr>
                <td colspan="4"><a href="<?= base_url('User/TransaksiPembelian/' . session('id_user')); ?>" class="btn btn-warning btn-xs btn-block">KEMBALI</a></td>
              </tr>
            </tbody>
          </table>
          <?php echo form_close() ?>
