<div class="col-md-12">
  ...
  <div class="card card-primary">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <?php echo form_open_multipart('User/UbahDataBarang/' . $barang['id_barang']) ?>
    <div class="card-body">
          ...
          <div class="row text-center">
            <div class="col-sm-12">
              ...
              <div class="form-group ">
                <img src="<?= base_url('foto/FotoBarang/' . $barang['foto1']); ?>" class="img-fluid" width="200px" height="200px" id="gambar_load">
              </div>
              <div class="col-sm-12">
                <div class="form-group ">
    ...
    <div class="card-footer">
      <a href="<?= base_url('User/LihatBarang/' . session('id_user')); ?>" class="btn btn-warning"><i class="fas fa-share"></i> Kembali</a>
